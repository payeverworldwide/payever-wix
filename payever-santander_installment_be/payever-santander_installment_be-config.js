...
export function getConfig() {
    return {
        ...
        paymentMethods: [
            {
                hostedPage: {
                    title: 'Santander Installments BE',
                    billingAddressMandatoryFields: ['CITY'],
                    logos: {
                        white: {
                            svg: 'https://payeverproduction.blob.core.windows.net/miscellaneous/2e551b84-c162-4963-97e6-af960f24d3f3-SANTANDER.svg',
                            png: 'https://payeverproduction.blob.core.windows.net/miscellaneous/2e551b84-c162-4963-97e6-af960f24d3f3-SANTANDER.png',
                        },
                        colored: {
                            svg: 'https://payeverproduction.blob.core.windows.net/miscellaneous/2e551b84-c162-4963-97e6-af960f24d3f3-SANTANDER.svg',
                            png: 'https://payeverproduction.blob.core.windows.net/miscellaneous/2e551b84-c162-4963-97e6-af960f24d3f3-SANTANDER.png',
