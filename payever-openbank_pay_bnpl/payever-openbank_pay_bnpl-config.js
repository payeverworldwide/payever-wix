...
export function getConfig() {
    return {
        ...
        paymentMethods: [
            {
                hostedPage: {
                    title: 'Openbank Pay - Buy Now Pay Later',
                    billingAddressMandatoryFields: ['CITY'],
                    logos: {
                        white: {
                            svg: 'https://payeverproduction.blob.core.windows.net/miscellaneous/b25580cd-8dd7-488a-8d0f-49046d62c251-OPENBANK.svg',
                            png: 'https://payeverproduction.blob.core.windows.net/miscellaneous/b25580cd-8dd7-488a-8d0f-49046d62c251-OPENBANK.png',
                        },
                        colored: {
                            svg: 'https://payeverproduction.blob.core.windows.net/miscellaneous/b25580cd-8dd7-488a-8d0f-49046d62c251-OPENBANK.svg',
                            png: 'https://payeverproduction.blob.core.windows.net/miscellaneous/b25580cd-8dd7-488a-8d0f-49046d62c251-OPENBANK.png',
