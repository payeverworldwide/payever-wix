...
export function getConfig() {
    return {
        ...
        paymentMethods: [
            {
                hostedPage: {
                    title: 'Resurs Installments',
                    billingAddressMandatoryFields: ['CITY'],
                    logos: {
                        white: {
                            svg: 'https://payeverproduction.blob.core.windows.net/miscellaneous/2a121d81-e403-4dc5-94fb-a505cd0b0847-RESURS-INSTALLMENT.svg',
                            png: 'https://payeverproduction.blob.core.windows.net/miscellaneous/2a121d81-e403-4dc5-94fb-a505cd0b0847-RESURS-INSTALLMENT.png',
                        },
                        colored: {
                            svg: 'https://payeverproduction.blob.core.windows.net/miscellaneous/2a121d81-e403-4dc5-94fb-a505cd0b0847-RESURS-INSTALLMENT.svg',
                            png: 'https://payeverproduction.blob.core.windows.net/miscellaneous/2a121d81-e403-4dc5-94fb-a505cd0b0847-RESURS-INSTALLMENT.png',
